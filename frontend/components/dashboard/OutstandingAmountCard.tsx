...
interface OutstandingAmountCardProps {
  loan: Loan;
}

export function OutstandingAmountCard({ loan }: OutstandingAmountCardProps) {
  ...
  return (
    <div className="bg-white border border-slate-200 rounded-xl p-5 shadow-xs space-y-4">
      <h4 className="text-xs font-semibold text-slate-500 uppercase tracking-wider">Repayment Progress</h4>
